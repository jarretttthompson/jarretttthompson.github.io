/**
 * Dev toolbar — device preview and quick nav. Loaded only on localhost.
 */
(function initDevToolbar() {
  ...
  const pages = [
    ...
    { label: 'Photo album', href: base + 'photo-album.html' },
    { label: 'Music', href: base + 'music.html' },
    { label: 'Friends', href: base + 'friends.html' },
    { label: 'Compositions', href: base + 'page5.html' },
  ];
  ...
  function applyPreview() {
    ...
    document.body.style.paddingBottom = TOOLBAR_H + 'px';
  ...
  function deactivatePreview() {
    if (savedBodyStyles) {
      ...
      document.body.style.paddingBottom = savedBodyStyles.paddingBottom;
